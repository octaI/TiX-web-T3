...
export const FETCH_LAST_ADMIN_REPORT_DATE = 'FETCH_LAST_ADMIN_REPORT_DATE';
...
export function fetchLastAdminReportDate(providerId, endDate) {
  return dispatch => dispatch({
    type: FETCH_LAST_ADMIN_REPORT_DATE,
    payload: fetch(`/admin/reports?providerId=${providerId}&startDate=${'2015-01-01'}&endDate=${endDate}`),
  });
}
